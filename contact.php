...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Contact us at auto quotable with any questions, comments, or feedback.">
    ...
    <meta property="og:description" content="Contact us at auto quotable with any questions, comments, or feedback."/>
    <meta name="twitter:card" content="summary" />
    <meta name="twitter:site" content="@autoquotable" />
    <meta name="twitter:title" content="Contact Us | Auto Quotable"/>
    <meta name="twitter:description" content="Get in touch with Auto Quotable." />
    ...
    <title>Auto Quotable | Contact Us</title>
    <!-- CSS -->
     ...
     <div class="container">
         <div class="row info">
             <div class="col-md-6 col-sm-6">
                 <div class="paragraph">
                    <p>Want to know more about us? Have a question or comment on how we can serve your auto body collision needs?<br/> Contact us. We're always happy to hear from customers.</p>
                 </div>
             </div>
             <div class="col-md-6 col-sm-6">
                 <div class="content2">
