...
<header id="quote">
    <div class="container">
        ...
        <h1 id="quote-title">Complete this form and we'll introduce you to pre-qualified auto body repair shops nearby.</h1>
    </div>
</header>
<!-- Main =========================================== -->
<section id="form">
...
<!-- Javascript -->
	...
	$("#file-3").fileinput({
		...
		fileType: "any",
        browseLabel: "Upload/Take Photo #3",
    ...
    $("#file-2").fileinput({
		...
		browseClass: "btn btn-default",
		fileType: "any",
        browseLabel: "Upload/Take Photo #2",
        browseIcon: '<i class="fa fa-camera"></i>',
        showRemove: false,
	}); 
    $("#file-1").fileinput({
		...
		browseClass: "btn btn-default",
		fileType: "any",
        browseLabel: "Upload/Take Photo #1",
        browseIcon: '<i class="fa fa-camera"></i>',
        showRemove: false,
	}); 
